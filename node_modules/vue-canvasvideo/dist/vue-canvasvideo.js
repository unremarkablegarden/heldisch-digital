...
(function (global, factory) {
	...
	(factory((global.VueCanvasvideo = global.VueCanvasvideo || {})));
...
var RangeSlider = function () {
  ...
  _createClass(RangeSlider, [{
    ...
    value: function _getPositionFromNode(node) {
      ...
      while (node !== null) {
        i += this$1.vertical ? node.offsetTop : node.offsetLeft;
...
var CanvasVideoControls = {
  ...
  watch: {
    elapsed: function elapsed (elapsed$1) {
  ...
  methods: {
    ...
    renderPlay: function renderPlay (h) {
      var this$1 = this;
      ...
      return h(
        'svg',
        {
          ...
          on: { click: function (e) { return this$1.$emit('play', e); } }
        },
        [
          h(
            'path',
    ...
    renderPause: function renderPause (h) {
      var this$1 = this;
      ...
      return h(
        'svg',
        {
          ...
          on: { click: function (e) { return this$1.$emit('pause', e); } }
        },
        [
          h(
            'path',
  ...
  mounted: function mounted () {
    ...
    rangeSlider$1.create(this.$refs.timeline, {
      value: 0,
      onSlide: function (position) { return this$1.$emit('scrubbing', position); },
      onSlideEnd: function (position) { return this$1.$emit('timechange', position); }
    });
  },
  computed: {
    durationRounded: function durationRounded () {
...
var CanvasVideo = {
    ...
    return (
      h(
        'div',
        {
          ...
          on: { click: function () { return this$1.videoClicked(); } },
          ref: 'videoWrapper'
        },
        [
          h(
            ...
            [
              ...
              this.controls &&
                h(
                  ...
                  {
                    on: {
                      pause: function (e) { return this$1.pause(e); },
                      play: function (e) { return this$1.play(e); },
                      scrubbing: function (val) { return this$1.scrub(val); },
                      timechange: function (val) { return this$1.jumpTime(val); }
                    },
                    props: {
  ...
  methods: {
    ...
    bind: function bind () {
      ...
      video.addEventListener('timeupdate', function () { return this$1.drawFrame(); });
      // Draw the first frame
      video.addEventListener('canplay', function () { return this$1.drawFrame(); });
      video.addEventListener('loadedmetadata', function () {
        this$1.duration = video.duration;
        // Set the canvas size to the video size once we know it...
        this$1.setCanvasSize();
      });
      // in case 'canplay' already fired
      if (video.readyState >= 2) { this.drawFrame(); }
      // debounce window resize
      window.addEventListener('resize', index(function () {
        this$1.setCanvasSize();
        this$1.drawFrame();
      }, 1000));
    },
    ...
    jumpTime: function jumpTime (time) {
    ...
    updateTime: function updateTime () {
      ...
      if (!this.timeInterval) {
        this.timeInterval = setInterval(function () {
          if (!this$1.playing) { this$1.stopUpdateTime(); }
          this$1.elapsed = this$1.$refs.video.currentTime;
        }, 500);
      }
    },
    ...
    renderVideo: function renderVideo () {
      ...
      var video = ref.video;
      var time = Date.now();
      var PreviousElapsed = (time - this.lastTime) / 1000;
      var currentElapsed = video.currentTime;
      ...
      if (this.playing) { this.animationFrame = window.requestAnimationFrame(function () { return this$1.renderVideo(); }); }
  ...
  computed: {
    computedWrapStyles: function computedWrapStyles () {
      var base = Object.assign({}, {paddingBottom: ((this.aspectRatio * 100) + "%")}, videoWrapInnerStyles);
      var centerSquare = { marginTop: (((1 - this.aspectRatio) / 2 * 100) + "%") };
    ...
    computedVideoStyles: function computedVideoStyles () {
      var cover = Object.assign({}, videoStyles, mediaCoveringStyles);
      if (this.showVideo) {
    ...
    computedCanvasStyles: function computedCanvasStyles () {
      var cover = Object.assign({}, videoCanvasStyles, mediaCoveringStyles);
